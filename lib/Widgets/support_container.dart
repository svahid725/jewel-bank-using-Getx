  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Assets.img.support.icon.image(height: 56, width: 56),
          const SizedBox(width: 16),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(
                'Need to contact support directly?',
                style: Get.textTheme.bodyText1!
                    .copyWith(color: Colors.white, fontWeight: FontWeight.w700),
              ),
              const SizedBox(height: 8),
              Text(
                'After buying an account\nyou can directly communicate with\nall the supporters',
                style: Get.textTheme.bodyText1!.copyWith(
                    color: MyColors.secondaryGrayTextColor, fontSize: 15),
              ),
              const SizedBox(height: 10),
              Row(
                children: [
                  InkWell(
                    onTap: () => Get.toNamed(RouteUtils.accountPurchase.name),
                    child: GradientText(
                      'Account purchase',
                      style: Get.textTheme.bodyText1!
                  ...
                  const Icon(Icons.arrow_forward_ios,
                      color: MyColors.secondaryGrayTextColor, size: 10)
                ],
              )
            ],
          )
